...
// to light). Measured on rgb("#1b1d23"): hue A 7.29:1, hue B 6.35:1, body
...
#let accent = if screen { rgb("#7eb2c8") } else { rgb("#286983") }   // hue A — the CHROME: the gutter rails + the crumb marks
#let accent2 = if screen { rgb("#d289ad") } else { rgb("#6a2f4d") }  // hue B — the LIVE STATE: the drawn marks + the dates
...
#let seg-radius = 0pt           // 0pt = square (flat dialect) · 2.5pt = pill

#let bodyf = ("Public Sans", "Noto Sans", "Liberation Sans")
#let dispf = ("Geist", "Instrument Sans", "Onest", "Noto Sans")
...
#let monof = ("Geist Mono", "Red Hat Mono", "Noto Sans Mono")
...
#set par(justify: false, leading: 0.761em, spacing: 0.851em)
